<main id="main">
    <div class="container">
        ...
        @if ($sproducts->count() > 0 && $sale->stutas == 1 && $sale->sale_date > Carbon\Carbon::now())
                        ...
                        <div class="product product-style-2 equal-elem ">
                            ...
                            <div class="product-info">
                                ...
                                <div class="wrap-price"><ins>
                                        ...
                                        <p class="product-price">${{ $sproduct->reguler_price }}</p>
                                    </del></div>
                            </div>
                        </div>
                    @endforeach
                                    ...
                                    <div class="product product-style-2 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><span
                                                    class="product-price">${{ $lproduct->reguler_price }}</span></div>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
